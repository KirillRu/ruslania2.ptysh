...
class CTemplate_CatalogBooksSearchFormFields extends CCommonTask
{
    var $fields;
    ...
    function getText()
    {
        ...
        $type_col = $cat->getNamedAttributeCollection("books_bindings");
...
return new CTemplate_CatalogBooksSearchFormFields();