...
class CTemplate_CatalogPrintedSortby extends CCommonTask
{
    var $sortbyTitles = NULL;
    var $fields = NULL;

    function CTemplate_CatalogPrintedSortby()
    {
    ...
    function setData(&$r)
    {
        ...
        {
            trigger_error("CTemplate_CatalogPrintedSortby::setData(...) receives incorrect parameter. ".
    ...
    function getText()
    {
        ...
        $s->add(SORTBY_ALL_DATE_ASC,        $ui->item("SORTBY_ALL_DATE_ASC"));
        $s->add(SORTBY_ALL_DATE_DESC,       $ui->item("SORTBY_ALL_DATE_DESC"));
...
return new CTemplate_CatalogPrintedSortby();
