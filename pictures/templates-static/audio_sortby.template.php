...
class CTemplate_CatalogAudioSortby extends CCommonTask
{
    var $sortbyTitles = NULL;
    var $fields = NULL;

    function CTemplate_CatalogAudioSortby()
    {
    ...
    function setData(&$r)
    {
        ...
        {
            trigger_error("CTemplate_CatalogAudioSortby::setData(...) receives incorrect parameter. ".
...
return new CTemplate_CatalogAudioSortby();
