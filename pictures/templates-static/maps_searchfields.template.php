...
class CTemplate_CatalogMapsSearchFormFields extends CCommonTask
{
    var $fields;
    ...
    function getText()
    {
        ...
        $type_col = $cat->getShortTitleNamedAttributeCollection("maps_bindings");
...
return new CTemplate_CatalogMapsSearchFormFields();