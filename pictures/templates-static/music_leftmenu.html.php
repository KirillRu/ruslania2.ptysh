...
$url = $var->getSaveResult
       (
           $url_part,
           $var->getSaveEntry("propertylist_type", PROPERTYLIST_FOR_PERFORMERS)
       ).".html";
$ui->add($url, "A_HREF_PROPERTYLIST_FOR_PERFORMERS");
...
?>
    <tr>
      ...
      <?=$ui->item("A_LEFT_MUSIC_SERIES_PROPERTYLIST");?></a></td>
    </tr>
    <tr>
      <td valign=top><img src=/pic/cl_f1.gif width=4 height=10></td>
      <td class=maintxt><a class=maintxt1
      href="<?=$ui->item("A_HREF_PROPERTYLIST_FOR_PUBLISHERS");?>">
      <?=$ui->item("A_LEFT_MUSIC_AZ_PROPERTYLIST_PUBLISHERS");?></a></td>
    </tr>
    <tr>
      <td valign=top><img src=/pic/cl_f1.gif width=4 height=10></td>
      <td class=maintxt><a class=maintxt1
      href="<?=$ui->item("A_HREF_PROPERTYLIST_FOR_AUTHORS");?>">
      <?=$ui->item("A_LEFT_MUSIC_AZ_PROPERTYLIST_AUTHORS");?></a></td>
    </tr>
    <tr>
      <td valign=top><img src=/pic/cl_f1.gif width=4 height=10></td>
      <td class=maintxt><a class=maintxt1
      href="<?=$ui->item("A_HREF_PROPERTYLIST_FOR_PERFORMERS");?>">
      <?=$ui->item("A_LEFT_MUSIC_AZ_PROPERTYLIST_PERFORMERS");?></a></td>
    </tr>
    <tr>
      <td valign=top><img src=/pic/cl_f1.gif width=4 height=10></td>
      <td class=maintxt><a class=maintxt1
      href="<?=$ui->item("A_HREF_SEARCH");?>">
      <?=$ui->item("A_LEFT_MUSIC_SEARCH");?></a></td>
    </tr>
  </table>
</td>
</tr>
