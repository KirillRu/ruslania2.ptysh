...
?>
    <tr>
      ...
      <?=$ui->item("A_LEFT_AUDIO_AZ_PROPERTYLIST_PUBLISHERS");?></a></td>
    </tr>
    <tr>
      <td valign=top><img src=/pic/cl_f1.gif width=4 height=10></td>
      <td class=maintxt><a class=maintxt1
      href="<?=$ui->item("A_HREF_PROPERTYLIST_FOR_AUTHORS");?>">
      <?=$ui->item("A_LEFT_AUDIO_AZ_PROPERTYLIST_AUTHORS");?></a></td>
    </tr>
    <tr>
      <td valign=top><img src=/pic/cl_f1.gif width=4 height=10></td>
      <td class=maintxt><a class=maintxt1
      href="<?=$ui->item("A_HREF_PROPERTYLIST_FOR_PERFORMERS");?>">
      <?=$ui->item("A_LEFT_AUDIO_AZ_PROPERTYLIST_PERFORMERS");?></a></td>
    </tr>
    <tr>
      <td valign=top><img src=/pic/cl_f1.gif width=4 height=10></td>
      <td class=maintxt><a class=maintxt1
      href="<?=$ui->item("A_HREF_SEARCH");?>">
      <?=$ui->item("A_LEFT_AUDIO_SEARCH");?></a></td>
    </tr>
  </table>
</td>
</tr>
