...
class CTemplate_CatalogSheetmusicSearchFormFields extends CCommonTask
{
    var $fields;
    ...
    function getText()
    {
        ...
        $type_col = $cat->getNamedAttributeCollection("musicsheets_bindings");
...
return new CTemplate_CatalogSheetmusicSearchFormFields();