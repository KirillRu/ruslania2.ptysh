...
class CTemplate_CatalogAudioItem extends CCommonTask
{
    var $fields = NULL;
    ...
    function getText()
    {
        ...
        {
            $ret .= "<br>".sprintf($ui->item('MSG_AUDIO_PLAYING_TIME'), $r->play_time);
        }
        ...
        {
            $ret .= 
                ';&nbsp;<a href="'.$r->secondary_category_url.'" title="'.
                $ui->item('DISPLAY_SUBCATEGORY_ITEMS').
        ...
        {
            $ret .= 
                "<div class=mt5 style=\"font-weight: bold\">#".
                $r->stock_id.
                "</div>";
        }
...
return new CTemplate_CatalogAudioItem();
