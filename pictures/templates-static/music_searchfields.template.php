...
class CTemplate_CatalogMusicSearchFormFields extends CCommonTask
{
    var $fields;
    ...
    function getText()
    {
        ...
        $type_col = $cat->getShortNamedAttributeCollection("music_media");
...
return new CTemplate_CatalogMusicSearchFormFields();