...
$url = $var->getSaveResult
       (
            $url_part,
            $var->getSaveEntry("propertylist_type", PROPERTYLIST_FOR_DIRECTORS)
       ).".html";
$ui->add($url, "A_HREF_PROPERTYLIST_FOR_DIRECTORS");


$url = $var->getSaveResult
       (
           $url_part,
           $var->getSaveEntry("propertylist_type", PROPERTYLIST_FOR_PRODUCERS)
       ).".html";
$ui->add($url, "A_HREF_PROPERTYLIST_FOR_PRODUCERS");

$url = $var->getSaveResult
       (
           $url_part,
           $var->getSaveEntry("propertylist_type", PROPERTYLIST_FOR_ACTORS)
       ).".html";
$ui->add($url, "A_HREF_PROPERTYLIST_FOR_ACTORS");
...
<tr>
  <td class=leftmnu2>
    ...
    <tr>
      ...
      <?=$ui->item("A_LEFT_VIDEO_CATTREE_PROPERTYLIST");?></a></td>
    </tr>
    <tr>
      <td valign=top><img src=/pic/cl_f1.gif width=4 height=10></td>
      <td class=maintxt><a class=maintxt1
      href="<?=$ui->item("A_HREF_PROPERTYLIST_FOR_DIRECTORS");?>">
      <?=$ui->item("A_LEFT_VIDEO_AZ_PROPERTYLIST_DIRECTORS");?></a></td>
    </tr>
    <tr>
      <td valign=top><img src=/pic/cl_f1.gif width=4 height=10></td>
      <td class=maintxt><a class=maintxt1
      href="<?=$ui->item("A_HREF_PROPERTYLIST_FOR_PRODUCERS");?>">
      <?=$ui->item("A_LEFT_VIDEO_AZ_PROPERTYLIST_PRODUCERS");?></a></td>
    </tr>
    <tr>
      <td valign=top><img src=/pic/cl_f1.gif width=4 height=10></td>
      <td class=maintxt><a class=maintxt1
      href="<?=$ui->item("A_HREF_PROPERTYLIST_FOR_ACTORS");?>">
      <?=$ui->item("A_LEFT_VIDEO_AZ_PROPERTYLIST_ACTORS");?></a></td>
    </tr>
    <tr>
      <td valign=top><img src=/pic/cl_f1.gif width=4 height=10></td>
      <td class=maintxt><a class=maintxt1
      href="<?=$ui->item("A_HREF_SEARCH");?>">
      <?=$ui->item("A_LEFT_VIDEO_SEARCH");?></a></td>
    </tr>
  </table>
</td>
</tr>
