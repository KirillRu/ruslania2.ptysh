...
class CTemplate_CatalogPrintedSearchFormFields extends CCommonTask
{
    var $fields;
    ...
    function getText()
    {
        ...
        $type_col = $cat->getNamedAttributeCollection("printed_bindings");
...
return new CTemplate_CatalogPrintedSearchFormFields();