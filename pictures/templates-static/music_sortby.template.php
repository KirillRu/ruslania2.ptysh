...
class CTemplate_CatalogMusicSortby extends CCommonTask
{
    var $sortbyTitles = NULL;
    var $fields = NULL;

    function CTemplate_CatalogMusicSortby()
    {
    ...
    function setData(&$r)
    {
        ...
        {
            trigger_error("CTemplate_CatalogMusicSortby::setData(...) receives incorrect parameter. ".
...
return new CTemplate_CatalogMusicSortby();
