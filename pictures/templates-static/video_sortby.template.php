...
class CTemplate_CatalogVideoSortby extends CCommonTask
{
    var $sortbyTitles = NULL;
    var $fields = NULL;

    function CTemplate_CatalogVideoSortby()
    {
    ...
    function setData(&$r)
    {
        ...
        {
            trigger_error("CTemplate_CatalogVideoSortby::setData(...) receives incorrect parameter. ".
...
return new CTemplate_CatalogVideoSortby();
