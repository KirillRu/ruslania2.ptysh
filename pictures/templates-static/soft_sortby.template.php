...
class CTemplate_CatalogSoftSortby extends CCommonTask
{
    var $sortbyTitles = NULL;
    var $fields = NULL;

    function CTemplate_CatalogSoftSortby()
    {
    ...
    function setData(&$r)
    {
        ...
        {
            trigger_error("CTemplate_CatalogSoftSortby::setData(...) receives incorrect parameter. ".
...
return new CTemplate_CatalogSoftSortby();
