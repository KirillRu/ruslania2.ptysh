...
class CTemplate_CatalogBooksItem extends CCommonTask
{
    var $fields = NULL;
    ...
    function getText()
    {
        ...
        if (!empty($r->publisher_name))
        {
            $ret .= sprintf ($ui->item("PUBLISHED_BY"),
                         ...
                         "\" title=\"".
                         $ui->item("FILTER_BOOKS_PUBLISHER").
                         "\" class=cprop>".
                         $r->publisher_name.
                         "</a> ");
        }
        ...
        if (!empty($r->binding_id))
        {
            ...
            $ret .= sprintf (
                    $ui->item("BINDING_TYPE_OF"),
                            ...
                            "\" title=\"".
                            $ui->item("FILTER_BOOKS_BINDING_TYPE").
                            "\" class=cprop>".
                            $r->binding_name.
                            "</a> "
                            );
...
return new CTemplate_CatalogBooksItem();
