...
class CTemplate_CatalogPereodicsSortby extends CCommonTask
{
    var $sortbyTitles = NULL;
    var $fields = NULL;

    function CTemplate_CatalogPereodicsSortby()
    {
    ...
    function getText()
    {
        ...
        $s->add(SORTBY_PEREODICS_ISSUES_YEAR_ASC,   $ui->item("SORTBY_PEREODICS_ISSUES_YEAR_ASC"));
        $s->add(SORTBY_PEREODICS_ISSUES_YEAR_DESC,  $ui->item("SORTBY_PEREODICS_ISSUES_YEAR_DESC"));
...
return new CTemplate_CatalogPereodicsSortby();
