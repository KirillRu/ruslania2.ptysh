<?
class CTemplate_PersonalRegistrationForm extends CCommonTask
{
    var $fields = NULL;
    var $html   = NULL;

    function CTemplate_PersonalRegistrationForm()
    {
                   ...
                   "<tr>".
                     ...
                     "</td><td class=maintxt-vat>".
                       ...
                       (
                         ...
                         $var->getSaveEntry("regform_password", EMPTY_STRING)
                       ).
                     "</td><td class=smalltxt1>".
                     "<img src=/pic1/arr3.gif width=8 height=7> ".
                     ...
                     "</td><td class=maintxt-vat>".
                       ...
                       (
                         "type=password class=simpletext size=25",
                         $var->getSaveEntry("regform_repeat_password", EMPTY_STRING)
                       ).
...
return new CTemplate_PersonalRegistrationForm();
