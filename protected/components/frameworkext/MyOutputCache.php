...
class MyOutputCache extends CFilterWidget
{
    const CACHE_KEY_PREFIX = 'Yii.MyOutputCache.';
    public $duration = 60;
    ...
    public function run()
    {
        ...
        else if ($this->_cache !== null)
        {
            ...
            $this->_cache->set($this->getCacheKey(), $data, $this->duration);
    ...
    protected function getCacheKey()
    {
        ...
        else
        {
            ...
            $params['currency'] = Yii::app()->currency;
            ksort($params);
